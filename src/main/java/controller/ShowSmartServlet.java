 ...
 * @author Tedu
 */
public class ShowSmartServlet extends ControllerServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        // 传入条件，查询文章
        List<SmartArticle> list = smartDao.getSmartArticlesByTag(pi);

        ctx.setVariable("smartArticle", list);
        ...
        ThymeleafHelper.ThymeleafWrite("smart", response, ctx);
    }
