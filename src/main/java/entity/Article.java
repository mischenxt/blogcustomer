...
public class Article {
    ...
    private int articleRandomDouble; // '文章随机数，用于快速查询随机文章列表',
    ...
    public Article(int oId, String articleTitle, String articleAbstract, int articleCommentCount, int articleViewCount,
                   ...
                   long articleCreated, long articleUpdated, int articleRandomDouble, int articleCommentable) {
        super();
        this.oId = oId;
    ...
    public Article(int oId, String articleTitle, String articleAbstract, int articleCommentCount, int articleViewCount,
                   String articleContent, int articleHadBeenPublished, int articleIsPublished, int articlePutTop,
                   long articleCreated, long articleUpdated, int articleRandomDouble, int articleCommentable, User user) {
        super();
        this.oId = oId;
        this.articleTitle = articleTitle;
        this.articleAbstract = articleAbstract;
    ...
    public String getArticleContent() {
        return MarkDownHelper.getHtmlStr(this.articleContent);
    }
